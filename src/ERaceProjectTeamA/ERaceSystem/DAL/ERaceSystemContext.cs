    ...
    internal partial class ERaceSystemContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Invoice>()
                ...
                // Each InvoiceDetail must be part of one and only one Invoice
                .WithRequired(e => e.Invoice)
                .WillCascadeOnDelete(false);

            // Each Invoice may be issued as a refund for one or more Store Refunds
            modelBuilder.Entity<Invoice>()
            ...
            modelBuilder.Entity<Invoice>()
                ...
                // Each StoreRefund must be fore something that was purchased on one and only one (original) Invoice
